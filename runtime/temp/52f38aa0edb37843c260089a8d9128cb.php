<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\WWW\cw-BE\public/../application/admin\view\user\user\edit.html";i:1667291745;s:55:"D:\WWW\cw-BE\application\admin\view\layout\default.html";i:1653893966;s:52:"D:\WWW\cw-BE\application\admin\view\common\meta.html";i:1653893966;s:54:"D:\WWW\cw-BE\application\admin\view\common\script.html";i:1653893966;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-invite-code" class="control-label col-xs-12 col-sm-2"><?php echo __('Invite Code'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-invite-code" data-rule="" class="form-control" readonly name="row[invite_code]" type="text" value="<?php echo $row['invite_code']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <div class="col-xs-12 col-sm-8">
                <?php echo build_radios('row[level]', ['1'=>__('Personal account'), '2'=>__('Business account')], $row['level']); ?>
            </div>
        </div>
    </div>
    <div class="form-group">
