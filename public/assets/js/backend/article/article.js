define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'status', title: __('Status'), operate: false, formatter: Table.api.formatter.status, searchList: {1: __('Normal'), 0: __('Hide')}},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'article/article/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
